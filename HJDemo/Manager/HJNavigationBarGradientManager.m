//
//  HJNavigationBarGradientManager.m
//  HJDemo
//
...
@implementation HJNavigationBarGradientManager
{
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    //    [navBar hj_setBackgroundAlpha:_navBarCurBgAlpha];
    [navBar hj_setBackgroundColor:[self.barBackColor colorWithAlphaComponent:_navBarCurBgAlpha]];
...
- (void)initialize{
    ...
    [navBar hj_setBackgroundAlpha:0];
